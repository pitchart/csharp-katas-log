...
namespace Tennis.Tests
{
    ...
    public class TestDataGenerator : IEnumerable<object[]>
    {
        private readonly List<object[]> _data = new List<object[]>
        {
            ...
            new object[] {4, 3, "AdvantageP1 player1"},
            new object[] {3, 4, "AdvantageP1 player2"},
            new object[] {5, 4, "AdvantageP1 player1"},
            new object[] {4, 5, "AdvantageP1 player2"},
            new object[] {15, 14, "AdvantageP1 player1"},
            new object[] {14, 15, "AdvantageP1 player2"},
